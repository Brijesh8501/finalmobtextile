...
$query_Recordset1 = "SELECT taka_d_c_mill.Taka_D_C_Id, taka_d_c_mill.Taka_Mill, taka_d_c_mill.Taka_D_C_Date, taka_d_c_mill.Entry_Date, taka_d_c_mill.Total_Taka, taka_d_c_mill.Entry_Id, taka_d_c_mill.Status FROM taka_d_c_mill";
...
<body>
            ...
            <div class="inner">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 align="center">MILL-TAKA CHALLAN PROFILE</h2>
                    </div>
                </div>
                <hr />
                <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading"><table border="0"><tr><td><a href="taka_d_cmill85?action=insert" target="_blank"><button class="btn btn-primary"><i class="icon-plus-sign icon-white"></i> Add Entry</button></a></td><td width="100%"><?php if(isset($_REQUEST['msg_error']))
...
{ echo $msg; } ?></td></tr></table></div>
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            <th width="12%">Mill-Challan ID</th>
                                            <th width="20%">Mill</th>
		   ...
		   else
		   {
                                     do { ?>
                                      <tr class="odd gradeX" id="<?php echo $row_Recordset1['Taka_D_C_Id']; ?>">
                                        ...
                                        <td><?php echo $row_Recordset1['Taka_Mill']; ?></td>
                                        <td><?php echo $row_Recordset1['Taka_D_C_Date']; ?></td>
                                        <td><?php echo $row_Recordset1['Total_Taka']; ?></td>
   ...
   $strshuffle = str_shuffle($encodedUrl); 
    ?> <div class="tooltip-demo">
                                       ...
                                       <a href="taka_d_cc_millview?view&Taka_D_C_Id=<?php echo $encodedUrl.''.$encodedUrl.''.$strshuffle; ?>" target="_blank"><button class="btn btn-inverse btn-xs" data-toggle="tooltip" data-placement="top" title="View" name="View<?php echo $row_Recordset1['Taka_D_C_Id']; ?>" id="View<?php echo $row_Recordset1['Taka_D_C_Id']; ?>"><i class="icon-eye-open"></i></button></a>&nbsp;                            
                                        <a href="taka_d_cmill85?action=update&Taka_D_C_Id=<?php echo $encodedUrl.''.$encodedUrl.''.$strshuffle; ?>" target="_blank"><button class="btn btn-inverse btn-xs" data-toggle="tooltip" data-placement="top" title="Update challan" name="Update<?php echo $row_Recordset1['Taka_D_C_Id']; ?>" id="Update<?php echo $row_Recordset1['Taka_D_C_Id']; ?>"><i class="icon-edit"></i></button></a>&nbsp;
                                         <a href="taka_d_cmill?print&Taka_D_C_Id=<?php echo $encodedUrl.''.$encodedUrl.''.$strshuffle; ?>" target="_blank"><button class="btn btn-inverse btn-xs" data-toggle="tooltip" data-placement="top" title="Print challan" name="Print<?php echo $row_Recordset1['Taka_D_C_Id']; ?>" id="Print<?php echo $row_Recordset1['Taka_D_C_Id']; ?>"><i class="icon-print"></i></button></a>&nbsp;
   ...
   <?php include("footer.php"); ?>
    ...
    <script>
	 $(document).ready(function () {
       ...
       $.post('taka_d_c_milllistdelete.php', {delete_id:del_id}, function(data) {
          if(data == 'true') {
