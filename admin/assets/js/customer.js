         $(document).ready(function () {
			 $('#Customer_Id').focus();
    $('#Cu_En_Name').on('keypress', function (e) {
...
$("#Cu_En_Name").blur(function(){
		t5=$("#Cu_En_Name").val().split(" ");
		var q="?Cu_En_Name="+t5+"&search=search";
		$("#show").load("customernamecheckajax.php"+q);
		 });
	$(".dropdown").hover(            
        function() {
...
var submitting = false;
    function Customer(mff)
{
	if(mff.Cu_En_Name.value=="")
    {
       alert("Customer name is required");
       mff.Cu_En_Name.focus();
       return false;
    }
