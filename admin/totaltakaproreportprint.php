...
<title>TAKA-PRO&nbsp;<?php echo $date.' - '.$date1;?></title>
  ...
  <tr  style="font-size:24px">
    ...
    <td>
      <div id="print-header-wrapper">
                    <div class="row-fluid">&nbsp;TOTAL-TAKA Production <b>Report</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i><?php echo $date.' - '.$date1;?></i></div>
  ...
  <tr align="center"> 
   <td><?php echo $i++; ?></td>
    ...
    <td><?php echo $rowMain['Quality_Name']; ?></td>
	  ...
	  $Tot_Wght = $Tot_Wght + $rowMain['Sum_Weight'];
     } while($rowMain = mysql_fetch_assoc($rsMain)); ?>
     <tr>
     <td colspan="4" align="right"><b>Total Meter : <?php echo moneyFormatIndia($Tot_Mtr);?>&nbsp;&nbsp;&nbsp;Total Weight : <?php echo $Tot_Wght;?></b></td>
     </tr>
</tbody>
        </table>
        </td>
