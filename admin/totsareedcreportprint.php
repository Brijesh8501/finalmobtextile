...
<title>SAREE [DC-SOLD]&nbsp;<?php echo $date.' - '.$date1;?></title>
  ...
  <tr  style="font-size:24px">
    ...
    <td>
      <div id="print-header-wrapper">
                    <div class="row-fluid">&nbsp;SAREE-Sold&nbsp;<b>Report</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i><?php echo $date.' - '.$date1;?></i></div>
  ...
  <tr align="center"> 
   ...
   <td><?php echo $rowMain['Design']; ?></td>
	...
	$Tot_Piecess = $Tot_Piecess + $rowMain['Sum_Pieces'];
     ...
     <tr>
     <td colspan="6" align="right"><b>Total Meter : <?php echo moneyFormatIndia($Tot_Mtr); ?>&nbsp;&nbsp;Total Weight : <?php echo moneyFormatIndia1($Tot_Weight);?>&nbsp;&nbsp;Total Piecess : <?php echo moneyFormatIndia1($Tot_Piecess);?></b></td>
     </tr>
</tbody>
        </table>
        </td>
