...
<?php include("sidemenu.php"); ?>
              <div class="inner">
                    <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" align="center">DELETE RECORDS BY DATE</h1>
                </div>
            </div>
<div class="row">
<div class="col-lg-12">
    <div class="box dark">
        ...
        <div class="form-group row">
         ...
         <div class="input-group">
                      ...
                      <option value="Salarymeter">Salary meter</option>
                      </select>
                      </div>
                      </center>
                      </fieldset> 
                   ...
                   <div align="center">
                        <button class="btn btn-primary btn-grad" type="button" id="delete" name="delete">Delete</button>
                   </div>  
                    <div id="loader">
                 </div>   
                  <hr />
...
<script>
     ...
     $("#delete").click(function(){
		...
		t1=$("#reportrange").val();
		t2=$("#type").val();
sql="?reportrange="+t1+"&type="+t2+"&delete=delete";
  $("#table").load("totalrecordsdelete.php"+sql);
  $("#loader").fadeOut();
  	  });
		 			 $(".dropdown").hover(            
        function() {
