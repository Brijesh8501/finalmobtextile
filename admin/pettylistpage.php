...
$query_Recordset1 = "SELECT * from petty_details";
...
<?php include("sidemenu.php"); ?>
            <div class="inner">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 align="center">PETTY ENTRY PROFILE</h2>
                    </div>
                </div>
                <hr />
                <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading"><a href="pettydetail?action=insert" target="_blank"><button class="btn btn-primary" > <i class="icon-plus-sign icon-white"></i> Add Entry</button></a> </div>
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            <th width="10%">Petty ID</th>
   ...
   $strshuffle = str_shuffle($encodedUrl);  ?>
                                            <td class="center" align="center"><div class="tooltip-demo">
                                             <a href="pettydetailview?view&Petty_Id=<?php echo $encodedUrl.''.$encodedUrl.''.$strshuffle; ?>" target="_blank"><button class="btn btn-inverse btn-xs" data-toggle="tooltip" data-placement="top" title="View" name="View<?php echo $row_Recordset1['Petty_Id']; ?>" id="View<?php echo $row_Recordset1['Petty_Id']; ?>"><i class="icon-eye-open"></i></button></a>&nbsp;
                                            <a href="pettydetail?action=update&Petty_Id=<?php echo $encodedUrl.''.$encodedUrl.''.$strshuffle; ?>" target="_blank"><button class="btn btn-inverse btn-xs" data-toggle="tooltip" data-placement="top" title="Update" name="Update<?php echo $row_Recordset1['Petty_Id']; ?>" id="Update<?php echo $row_Recordset1['Petty_Id']; ?>"><i class="icon-edit"></i></button></a>&nbsp;
    ...
    <script>
	 $(document).ready(function () {
       ...
       $.post('petty_deletelist.php', {delete_id:del_id}, function(data) {
          if(data == 'true') {
