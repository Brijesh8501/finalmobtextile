...
$query_rsTakaid = "SELECT taka_dcorgmill.Ta_D_C_Id, taka_dcorgmill.Taka_D_C_Id, taka_dcorgmill.Taka_Id, taka_dcorgmill.Taka_Meter, taka_dcorgmill.Taka_Weight, taka_dcorgmill.R_Id, quality_details.Quality_Name FROM taka_dcorgmill, quality_details WHERE quality_details.Quality_Id = taka_dcorgmill.Quality_Id AND taka_dcorgmill.Taka_D_C_Id='".$Taka_D_C_Id."' ";
    ...
    <div class="box dark">
        <div id="div-1" class="accordion-body collapse in body">
            ...
            <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <textarea rows="3" cols="20" id="textarea1" name="Taka_Mill" class="form-control" readonly><?php echo $Taka_Mill;?></textarea>
                    </div>
                </div>
                        </div>
                       <div class="col-lg-4">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4">
                            <a href="taka_d_c_milllist"><input type="button" value=" Back" class="btn btn-inverse btn-lg " /></a>
                        </div>
                    </div>
                </form>
            </div>
