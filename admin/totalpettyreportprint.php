...
{
	$query1 = "SELECT * FROM `petty_details` where Date between '".$dt."' and '".$dt1."' AND Payment_Type='$TypePetty' order by Petty_Id asc ";
...
{
	$query1 = "SELECT * FROM `petty_details` where Date between '".$dt."' and '".$dt1."' order by Petty_Id asc ";
 $rsMain = mysql_query($query1);
	$rowMain = mysql_fetch_array($rsMain);
	$totalRowsRsMain = mysql_num_rows($rsMain);
	}
...
<title>PETTY&nbsp;[<?php echo $TypePetty;?>]&nbsp;&nbsp;<?php echo $date.' - '.$date1;?></title>
...
<table width="990" border="0" align="center" cellpadding="5" cellspacing="5" >
  <tr  style="font-size:24px">
    ...
    <td>
      <div id="print-header-wrapper">
                    <div class="row-fluid">&nbsp;PETTY ENTRY <b>Report</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i><?php echo $date.' - '.$date1;?></i></div>
  ...
  <tr>  
    <td colspan="10" valign="top">
        ...
        <thead>
          <tr>
                                             <th width="12%"><center>Expense ID</center></th>
