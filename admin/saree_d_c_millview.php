...
$query_rsLotid = "SELECT saree_dcorgmill.Sa_D_C_Id, saree_dcorgmill.Saree_D_C_Id, saree_dcorgmill.Saree_Lot_Id, saree_dcorgmill.Saree_Lot_Meter, saree_dcorgmill.Saree_Pieces, saree_dcorgmill.Saree_Weight, quality_details.Quality_Name, design_details.Design, saree_dcorgmill.R_Id FROM saree_dcorgmill, quality_details, design_details WHERE quality_details.Quality_Id = design_details.Quality_Id AND design_details.Design_Id = saree_dcorgmill.Design_Id AND saree_dcorgmill.Saree_D_C_Id='".$Saree_D_C_Id."' ";
...
<div class="col-lg-12">
        ...
        <div id="div-1" class="accordion-body collapse in body">
            ...
            <div class="form-group">
                    ...
                    <span id="error1" style="color:#F00";></span>
                        <textarea rows="3" cols="20" id="textarea1" name="Saree_Mill" class="form-control" readonly><?php echo $Saree_Mill;?></textarea>
                    </div>
                </div>
                        </div>
                       <div class="col-lg-4">
  ...
  <?php } while ($row_rsLotid = mysql_fetch_assoc($rsLotid)); ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4">
                           <a href="saree_d_c_milllist"> <input type="button" value=" Back" class="btn btn-inverse btn-lg " /></a>
                        </div>
                    </div>
                </form>
            </div>
