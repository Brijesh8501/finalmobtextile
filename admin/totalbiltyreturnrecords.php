...
<?php include("sidemenu.php"); ?>
                <div class="inner">
                    <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" align="center">BILTY ENTRY-RETURN REPORT</h1>
                </div>
            </div>
<div class="row">
<div class="col-lg-12">
...
sql="?reportrange="+t1+"&Search=Search";
  $("#table").load("totalbiltyreturnreportstable.php"+sql);
   $("#loader").fadeOut();
		  });
...
sql="?Ref_No="+t1+"&Searchref=Searchref";
  $("#tableprint").load("totalbiltyreturnprintreportstable.php"+sql);
   $("#loader").fadeOut();
		  });
		 $(".dropdown").hover(            
        function() {
