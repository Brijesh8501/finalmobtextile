...
<div class="col-lg-12">
    <div class="box dark">
        <div id="div-1" class="accordion-body collapse in body">
            ...
            <div class="form-group">
                    ...
                    <div class="col-lg-7">
                    <input type="text" id="Other_D_C_Id" placeholder="" class="form-control" value="<?php echo $Other_D_C_Id; ?>" name="Other_D_C_Id" readonly/>
                    </div>
                </div>
                        </div>
                         <div class="col-lg-4">
                    ...
                    <div class="col-lg-7">
                    <input type="text" id="Other_D_C_Date" placeholder="" class="form-control" value="<?php echo $Other_D_C_Date; ?>" name="Other_D_C_Date" readonly/>
                    </div>
                </div>
                      </div>
                    </div>
  ...
  <tr>
    <td><?php echo $i++; ?></td>
    <td><?php echo $row_rsLotid['Mach_Pname']; ?></td>
   <td><?php echo $row_rsLotid['Quantity']; ?></td>
  ...
  <?php } while ($row_rsLotid = mysql_fetch_assoc($rsLotid)); ?>
                    ...
                    <div class="col-lg-7">
                    <input type="text" id="Total_Beam" placeholder="" class="form-control" name="Total_Beam" value="<?php echo $Total_Other; ?>" readonly />
                    </div>
                </div>
                        </div>
                        <div class="col-lg-4">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-4">
                           <a href="other_d_c_migratelist"> <input type="button" value=" Back" class="btn btn-inverse btn-lg " /></a>
                        </div>
                    </div>
                </form>
            </div>
