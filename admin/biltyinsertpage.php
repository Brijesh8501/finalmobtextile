...
if ($image) 
{
 ...
 $query = mysql_query("select * from bilty_details where Ref_No='".$Ref_No."' ") or die(mysql_error());
$duplicate = mysql_num_rows($query);
   if($duplicate==0)
	...
	$Partact = "New Bilty Entry [Normal]<br/>Reference No : ".$Ref_No;
	...
	mysql_query($insactivity);  	
      $query1 = mysql_query("INSERT INTO `bilty_details` (`Bilty_Id`, `Ref_No`,`B_Date`,`B_Image`, `Entry_Id`) VALUES (NULL, '$Ref_No','$B_Date','".$newname."', '$Entry_Id')") or die(mysql_error());
	   $insertGoTo = "biltylistpage";
...
<?php include("sidemenu.php"); ?>
              <div class="inner">
                    <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" align="center">BITLY ENTRY-NORMAL</h1>
                </div>
            </div>
<div class="row">
<div class="col-lg-12">
                                ...
                                <div>
                                    ...
                                    <a href="#" class="btn btn-danger fileupload-exists" data-dismiss="fileupload">Remove</a> &nbsp;&nbsp;<span style="color:#F00";>only JPG, GIF, PNG, JPEG extensions are accepted</span>
                                        ...
                                        <div style="text-align:center" class="form-actions no-margin-bottom">
                                         <a href="biltylistpage">   <input type="button" value="Back" class="btn btn-inverse btn-lg " /></a>
                                         <?php
                                            if($days_remaining<=0)
{
...
<script src="assets/js/biltynorins.js"></script>
