...
$query_RsTakaDetails = "SELECT taka_dcorgmigrate.Ta_D_C_Id, taka_dcorgmigrate.Taka_D_C_Id, taka_dcorgmigrate.Taka_Id, taka_dcorgmigrate.Taka_Meter, taka_dcorgmigrate.Taka_Weight, quality_details.Quality_Name FROM taka_dcorgmigrate, quality_details WHERE quality_details.Quality_Id = taka_dcorgmigrate.Quality_Id AND taka_dcorgmigrate.Taka_D_C_Id='".$Taka_D_C_Id."' order by Ta_D_C_Id asc";
    ...
    <td colspan="4"><table width="100%" border="1" cellspacing="2" cellpadding="2" style="border-color:#000" class="table">
      <tr style="background-color:#FFF ; color:#000">
        <td colspan="3" valign="top"><table width="100%" border="0" cellspacing="2" cellpadding="2" >
          <tr>
            <td width="10%">To :</td>
            <td width="90%">M/s.&nbsp;<strong><?php echo $Taka_Mig; ?></strong></td>
          </tr>
         </table></td>
