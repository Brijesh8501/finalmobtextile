...
if(isset($_REQUEST['print']))
{
	...
	$query1="select * from bilty_details where Ref_No = '$Ref_No'";
...
<title>BILTY[E-NORMAL] <?php echo date('Y/m/d h:i:s A'); ?></title>
  ...
  <tr  style="font-size:24px">
    ...
    <td>
      <div id="print-header-wrapper">
                    <div class="row-fluid">&nbsp;&nbsp;&nbsp;BILTY[E-NORMAL] <b>Report</b>&nbsp;&nbsp;&nbsp;</i></div>
