...
/////////////////////// total for year ///////////////////////////////////////////////////////
/*$sel_amtbobbin = "select sum(Trans_Amt) as sum_amt from transactions_bobbin where Trans_Date like '2016%' or Trans_Date like '2017%'";
$sel_amtbobbin_exe = mysql_query($sel_amtbobbin);
$sel_amtbobbin_fetch = mysql_fetch_array($sel_amtbobbin_exe);
$sel_amtbobbin_num = mysql_num_rows($sel_amtbobbin_exe);

$sel_amtbeam = "select sum(Trans_Amt) as sum_amt from transactions_beam1 where Trans_Date like '2016%' or Trans_Date like '2017%'";
$sel_amtbeam_exe = mysql_query($sel_amtbeam);
$sel_amtbeam_fetch = mysql_fetch_array($sel_amtbeam_exe);
$sel_amtbeam_num = mysql_num_rows($sel_amtbeam_exe);

$sel_amttaka = "select sum(Trans_Amt) as sum_amt from transactions_taka where Trans_Date like '2016%' or Trans_Date like '2017%'";
$sel_amttaka_exe = mysql_query($sel_amttaka);
$sel_amttaka_fetch = mysql_fetch_array($sel_amttaka_exe);
$sel_amttaka_num = mysql_num_rows($sel_amttaka_exe);

$sel_amtsaree = "select sum(Trans_Amt) as sum_amt from transactions_saree where Trans_Date like '2016%' or Trans_Date like '2017%'";
$sel_amtsaree_exe = mysql_query($sel_amtsaree);
$sel_amtsaree_fetch = mysql_fetch_array($sel_amtsaree_exe);
$sel_amtsaree_num = mysql_num_rows($sel_amtsaree_exe);*/
//////////////////// Petty ////////////////////////////////////
//////////////////// January ///////////////////////////////////////////
  ...
  <tr  style="font-size:24px">
    ...
    <td>
      <div id="print-header-wrapper">
                    <div class="row-fluid">YEARLY REPORT <i>[CA]</i></div>
