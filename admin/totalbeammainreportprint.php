...
<title>BEAM-DC[M] <?php echo $date.' - '.$date1;?></title>
...
<table width="990" border="0" align="center" cellpadding="5" cellspacing="5" >
  <tr  style="font-size:24px">
    ...
    <td>
      <div id="print-header-wrapper">
                    <div class="row-fluid">&nbsp;&nbsp;&nbsp;Main-BEAM CHALLAN <b>Report</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i><?php echo $date.' - '.$date1;?></i></div>
    ...
    <td colspan="8" valign="top">
        ...
        <thead>
          <tr>
                                            ...
                                            <th width="35%"><center>Broker</center></th>
                                            <th width="10%"><center>Beam</center></th>
  ...
  <tr align="center"> 
    ...
    <td><?php echo $rowMain['Beam_D_C_No']; ?></td>
