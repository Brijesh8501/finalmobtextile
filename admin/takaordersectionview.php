...
<div class="col-lg-12">
    <div class="box dark">
        <div id="div-1" class="accordion-body collapse in body">
            ...
            <div class="form-group">
                    ...
                    <div class="col-lg-7">
                    <input type="text" id="T_Order_Id" placeholder="" class="form-control" value="<?php echo $t2; ?>" name="T_Order_Id" readonly />
                    </div>
                </div>
                        </div>
                       <div class="col-lg-4">
                    ...
                    <div class="col-lg-7">
                    <input type="text" id="Order_Id" placeholder="" class="form-control" value="<?php echo $T_Order_Id; ?>" name="Order_Id" readonly />
                    </div>
                </div>
                        </div>
                    </div>
  ...
  <?php } while ($row_RsOrderDetails = mysql_fetch_assoc($RsOrderDetails)); ?>
                    ...
                    <div class="col-lg-6">
                    <input type="text" id="Delivery_Date" placeholder="" class="form-control" name="Delivery_Date" value="<?php echo $Delivery_Date; ?>" readonly/>
                    </div>
                </div>
                    </div>
                         <div class="col-lg-2">
