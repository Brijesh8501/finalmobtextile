...
else
{
	?>
<div align="right">
<a href="totalpettyreportprint?print&reportrange=<?php echo $reportrange; ?>&TypePetty=<?php echo $TypePetty;?>" target="_blank"><i class="icon-print"></i></a>
</div>
 <table class="table table-striped table-bordered table-hover" valign="center">
                                    <thead>
                                        <tr> 
                                        <th width="7%">Sr No.</th>
                                             <th width="12%">Expense ID</th>
