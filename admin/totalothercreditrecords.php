...
<?php include("sidemenu.php"); ?>
                <div class="inner">
                    <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" align="center">OTHER-CREDIT ENTRY REPORT</h1>
                </div>
            </div>
<div class="row">
<div class="col-lg-12">
    <div class="box dark">
        ...
        <div class="form-group row">
         ...
         <div class="input-group">
                      ...
                      <option value="Other_Interest">Other_Interest</option>
                      </select>
                      </div>
                      </center>
                      </fieldset> 
...
sql="?reportrange="+t1+"&TypePetty="+t2+"&SearchPetty=SearchPetty";
  $("#tablePetty").load("totalothercreditreportstable.php"+sql);
   $("#loader").fadeOut();
		  });
		 $(".dropdown").hover(            
        function() {
