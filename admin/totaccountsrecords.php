...
<?php include("sidemenu.php"); ?>
                <div class="inner">
                    <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header" align="center">FINANCIAL STATEMENT REPORT</h1>
                </div>
            </div>
<div class="row">
<div class="col-lg-12">
...
<script>
   ...
   $("#Search").click(function(){
	   $("#loader").fadeIn();
		t1=$("#reportrange").val();
		t2=$("#Typebank").val();
sql="?reportrange="+t1+"&Typebank="+t2+"&Search=Search";
  $("#table").load("totalaccountsreportstable.php"+sql);
   $("#loader").fadeOut();
		  });
		 $(".dropdown").hover(            
        function() {
