...
<title>SAREE-PRO[T]&nbsp;<?php echo $date.' - '.$date1;?></title>
  ...
  <tr  style="font-size:24px">
    ...
    <td>
      <div id="print-header-wrapper">
                    <div class="row-fluid">&nbsp;TOTAL-SAREE Production <b>Report</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i><?php echo $date.' - '.$date1;?></i></div>
        ...
        <thead>
          <tr>
                                        <th width="7%"><center>Sr No.</center></th>
                                            ...
                                            <th width="15%"><center>Design</center></th>
      </tr> 
       </thead>
       <tbody>
    <?php
  ...
  <tr align="center"> 
   <td><?php echo $i++; ?></td>
    ...
    <td><?php echo $rowMain['Design']; ?></td>
     ...
     <tr>
     <td colspan="6" align="right"><b>Total Meter : <?php echo moneyFormatIndia($Tot_Mtr);?>&nbsp;&nbsp;Total Weight : <?php echo moneyFormatIndia($Tot_Weight);?>&nbsp;&nbsp;Total Piecess : <?php echo moneyFormatIndia1($Tot_Piecess);?> </b></td>
     </tr>
</tbody>
        </table>
        </td>
